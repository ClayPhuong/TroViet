...
public class HoaDon {
    ...
    public HoaDon( long idHopDong, String ngayBD, String ngayKT, float soDienCu, float soDienMoi, float soNuocCu, float soNuocMoi, float khauTru, float no, float tongCong, String ngayTao, String nguoiTao, String ngaySua, String nguoiSua, int trash, HoaDonEnum status) {
